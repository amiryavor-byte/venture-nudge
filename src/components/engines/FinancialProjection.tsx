...
import { BusinessPlanData, calculateExponentialGrowth } from '@/lib/engines/business-plan-service';
    ...
    return (
        <div className="overflow-x-auto">
            <div className="mb-6 grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
                <div>
                    <span className="text-xs text-gray-500 font-semibold uppercase">Unit Sale (Low)</span>
                ...
                <div>
                    <span className="text-xs text-gray-500 font-semibold uppercase">Unit Sale (High)</span>
                    <div className="flex items-center text-green-700 font-bold text-lg">
                ...
                <div>
                    <span className="text-xs text-gray-500 font-semibold uppercase">Upsell Value (Low)</span>
                    <div className="flex items-center text-green-700 font-bold text-lg">
                        $<InlineEditable value={data.featurePriceLow.toString()} onSave={(v) => updateGlobal('featurePriceLow', Number(v))} />
                    </div>
                </div>
                <div>
                    <span className="text-xs text-gray-500 font-semibold uppercase">Upsell Value (High)</span>
                    <div className="flex items-center text-green-700 font-bold text-lg">
                        $<InlineEditable value={(data.featurePriceHigh || 1500).toString()} onSave={(v) => updateGlobal('featurePriceHigh', Number(v))} />
                    </div>
                </div>
                <div>
                    <span className="text-xs text-gray-500 font-semibold uppercase">Billable Rate</span>
                ...
                <div>
                    <span className="text-xs text-gray-500 font-semibold uppercase">Capacity (Units/Staff)</span>
                ...
                <div>
                    <span className="text-xs text-gray-500 font-semibold uppercase">Staff Cost (Monthly)</span>
                ...
                <table className="min-w-full text-sm text-left">
                    <thead className="bg-gray-100 text-gray-600 font-semibold sticky top-0 z-10">
                        <tr>
                            ...
                            <th className="px-4 py-2">Customers/Units</th>
                            {/* <th className="px-4 py-2">Upgrade %</th> */}
                            <th className="px-4 py-2">Revenue</th>
                            <th className="px-4 py-2 text-red-600">Staffing</th>
                            <th className="px-4 py-2">Expenses</th>
                            <th className="px-4 py-2 bg-green-50">Net Profit</th>
                            <th className="px-4 py-2 bg-blue-50">Founder Share</th>
                        </tr>
                    </thead>
